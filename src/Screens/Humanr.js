...
import { Accordion, Box, Button, CardContent, Container, Divider, Grid, Typography } from '@mui/material'
  ...
  return (
    ...
    <Typography variant="h5" sx={{ mb:5 }} component="div">
      ...
      <Grid container spacing={5}>
        ...
        <Button style={{ minHeight: 100, width:'100%', backgroundColor:'#3fa435' }}>
                <CardContent sx={{
                        display: 'flex',
                        alignItems: 'center',
                        height:100,
        ...
        <Grid item md={6} xs={12}>
        <Button style={{ minHeight: 100, width:'100%', backgroundColor:'#2b2b2b' }}>
                <CardContent sx={{
                        display: 'flex',
                        alignItems: 'center',
                        height:100,
